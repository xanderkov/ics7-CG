...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButtonWhite_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonWhite_bg.setChecked(True)
        self.radioButtonWhite_bg.setObjectName("radioButtonWhite_bg")
        self.verticalLayout_2.addWidget(self.radioButtonWhite_bg)
        self.radioButtonBlack_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonBlack_bg.setObjectName("radioButtonBlack_bg")
        self.verticalLayout_2.addWidget(self.radioButtonBlack_bg)
        self.radioButtonYellow_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonYellow_bg.setObjectName("radioButtonYellow_bg")
        self.verticalLayout_2.addWidget(self.radioButtonYellow_bg)
        self.radioButtonGreen_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonGreen_bg.setObjectName("radioButtonGreen_bg")
        self.verticalLayout_2.addWidget(self.radioButtonGreen_bg)
        self.radioButtonRed_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonRed_bg.setObjectName("radioButtonRed_bg")
        self.verticalLayout_2.addWidget(self.radioButtonRed_bg)
        self.radioButtonBlue_bg = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonBlue_bg.setObjectName("radioButtonBlue_bg")
        self.verticalLayout_2.addWidget(self.radioButtonBlue_bg)
        ...
        self.radioButtonBlack_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonBlack_line.setChecked(True)
        self.radioButtonBlack_line.setObjectName("radioButtonBlack_line")
        self.verticalLayout_3.addWidget(self.radioButtonBlack_line)
        self.radioButtonWhite_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonWhite_line.setChecked(False)
        self.radioButtonWhite_line.setObjectName("radioButtonWhite_line")
        self.verticalLayout_3.addWidget(self.radioButtonWhite_line)
        self.radioButtonYellow_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonYellow_line.setObjectName("radioButtonYellow_line")
        self.verticalLayout_3.addWidget(self.radioButtonYellow_line)
        self.radioButtonGreen_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonGreen_line.setObjectName("radioButtonGreen_line")
        self.verticalLayout_3.addWidget(self.radioButtonGreen_line)
        self.radioButtonRed_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonRed_line.setObjectName("radioButtonRed_line")
        self.verticalLayout_3.addWidget(self.radioButtonRed_line)
        self.radioButtonBlue_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonBlue_line.setObjectName("radioButtonBlue_line")
        self.verticalLayout_3.addWidget(self.radioButtonBlue_line)
        self.radioButtonFon_line = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonFon_line.setChecked(False)
        self.radioButtonFon_line.setObjectName("radioButtonFon_line")
        self.verticalLayout_3.addWidget(self.radioButtonFon_line)
        ...
        self.radioButtonCanon = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonCanon.setChecked(True)
        self.radioButtonCanon.setObjectName("radioButtonCanon")
        self.verticalLayout_4.addWidget(self.radioButtonCanon)
        self.radioButtonParam = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonParam.setObjectName("radioButtonParam")
        self.verticalLayout_4.addWidget(self.radioButtonParam)
        self.radioButtonBres = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonBres.setObjectName("radioButtonBres")
        self.verticalLayout_4.addWidget(self.radioButtonBres)
        self.radioButtonMidPoint = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonMidPoint.setObjectName("radioButtonMidPoint")
        self.verticalLayout_4.addWidget(self.radioButtonMidPoint)
        self.radioButtonLib = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonLib.setObjectName("radioButtonLib")
        self.verticalLayout_4.addWidget(self.radioButtonLib)
        ...
        self.lineEditcicX.setProperty("value", 375.0)
        ...
        self.lineEditcicY.setProperty("value", 375.0)
        ...
        self.lineEditcicX_2.setProperty("value", 375.0)
        ...
        self.lineEditcicY_2.setProperty("value", 375.0)
        ...
        self.lineEditcount.setProperty("value", 20.0)
        ...
        self.lineEditcount_2.setProperty("value", 20.0)
